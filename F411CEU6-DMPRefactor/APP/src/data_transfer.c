...
void ANO_DT_PIDControl(void)
{
	if(USART_RX_STA==0x8000)
	{
		...
		{
			if(USART_RX_BUF[1]=='P')
			AngleRingPID.P=atof((char*)(USART_RX_BUF+2));    
			else if(USART_RX_BUF[1]=='I')
			AngleRingPID.I=atof((char*)(USART_RX_BUF+2));
			else if(USART_RX_BUF[1]=='D')
			AngleRingPID.D=atof((char*)(USART_RX_BUF+2));
		}
		else if(USART_RX_BUF[0]=='S')
		{
			if(USART_RX_BUF[1]=='P')
			SpeedRingPID.P=atof((char*)(USART_RX_BUF+2));
			else if(USART_RX_BUF[1]=='I')
			SpeedRingPID.I=atof((char*)(USART_RX_BUF+2));
			else if(USART_RX_BUF[1]=='D')
			SpeedRingPID.D=atof((char*)(USART_RX_BUF+2));
		}
		else if(USART_RX_BUF[0]=='M')
		{
			if(USART_RX_BUF[2]=='P')
			MotorRingPID[USART_RX_BUF[1]-'0'].P=atof((char*)(USART_RX_BUF+3));
			else if(USART_RX_BUF[2]=='I')
			MotorRingPID[USART_RX_BUF[1]-'0'].I=atof((char*)(USART_RX_BUF+3));
			else if(USART_RX_BUF[2]=='D')
			MotorRingPID[USART_RX_BUF[1]-'0'].D=atof((char*)(USART_RX_BUF+3));
		}
		for(int i=0;i<50;i++) //清除缓冲区
		{
			USART_RX_BUF[i]=0;
		}
